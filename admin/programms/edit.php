...
<tr>
	...
	<td>
		...
		<a href="/admin/programms/index.php"><< Назад в таблицу</a>
		<!--  start step-holder -->
		...
		<tr>
			<th valign="top">Сессии:</th>
			<td><textarea name="sessions"  class="form-textarea" ><?php echo $ticket['sessions']?></textarea></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Сессии (En):</th>
			<td><textarea name="sessions_en"  class="form-textarea" ><?php echo $ticket['sessions_en']?></textarea></td>
			<td></td>
		</tr>
		<tr>
