	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				?>
				<?php require_once($_SERVER['DOCUMENT_ROOT'].'/admin/querysets/speakers/list.php'); ?>
				<?php foreach ($tickets as $ticket){ ?>
					<tr>
						...
						<a href="/admin/querysets/speakers/delete.php?id=<?php echo $ticket['id'];?>" title="delete" class="icon-2 info-tooltip"></a>
						</td>
					</tr>
				<?php } ?>
				</table>
